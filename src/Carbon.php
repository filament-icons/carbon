...
enum Carbon: string implements ScalableIcon
{
    ...
    case CZ = 'cZ';
    case CcX = 'ccX';
    case CircuitComposer = 'circuit-composer';
    case ComposerEdit = 'composer-edit';
    case HintonPlot = 'hinton-plot';
    case ID = 'iD';
    case Matrix = 'matrix';
    case OperationGauge = 'operation--gauge';
    case OperationIf = 'operation--if';
    ...
    case Add = 'add';
    case AggregatorCountRows = 'aggregator--count-rows';
    case AggregatorRecalculation = 'aggregator--recalculation';
    ...
    case BaseDocumentSet = 'base-document-set';
    ...
    case FollowUpWorkOrder = 'follow-up-work-order';
    ...
    case FunnelSequence = 'funnel--sequence';
    case FunnelSort = 'funnel--sort';
    ...
    case IbmSoftwareWatsonxDataAnalyzeAndProcess = 'ibm-software--watsonx--data--analyze-and-process';
    case IbmSoftwareWatsonxDataStructuredEnrichment = 'ibm-software--watsonx--data--structured--enrichment';
    case IbmSoftwareWatsonxDataStructuredImport = 'ibm-software--watsonx--data--structured--import';
    case IbmSoftwareWatsonxDataUnstructuredEnrichment = 'ibm-software--watsonx--data--unstructured--enrichment';
    case IbmSoftwareWatsonxDataUnstructuredImport = 'ibm-software--watsonx--data--unstructured--import';
    case IbmSoftwareWatsonxDocumentLibrary = 'ibm-software--watsonx--document--library';
    ...
    case JoinInnerAlt = 'join--inner--alt';
    case JoinInner = 'join--inner';
    case JoinLeftOuter = 'join--left-outer';
    case JoinLeft = 'join--left';
    case JoinOuter = 'join--outer';
    case JoinRightOuter = 'join--right-outer';
    ...
    case PivotHorizontal = 'pivot--horizontal';
    case PivotVertical = 'pivot--vertical';
    case Plan = 'plan';
    ...
    case SurrogateKeyDatabase = 'surrogate--key-database';
    case SurrogateKeyFlatFile = 'surrogate--key-flat-file';
    ...
    case Icon3DCursor = '3D-Cursor';
    case Icon3DMPRToggle = '3D-MPR-Toggle';
    case Icon3DCursorAlt = '3D-cursor--alt';
    case Icon3DCurveAutoColon = '3D-curve--auto-colon';
    case Icon3DCurveAutoVessels = '3D-curve--auto-vessels';
    case Icon3DCurveManual = '3D-curve--manual';
    case Icon3DICa = '3D-iCa';
    case Icon3DPrintMesh = '3D-print-mesh';
    case Icon3DSoftware = '3D-software';
    case Icon3rdPartyConnected = '3rd-party-connected';
    case HL7Attributes = 'HL7-attributes';
    case QCLaunch = 'QC-launch';
    case AiResultsHigh = 'ai-results--high';
    case AiResultsLow = 'ai-results--low';
    case AiResultsMedium = 'ai-results--medium';
    case AiResultsUrgent = 'ai-results--urgent';
    case AiResultsVeryHigh = 'ai-results--very-high';
    case AiResults = 'ai-results';
    case AiStatusComplete = 'ai-status--complete';
    case AiStatusFailed = 'ai-status--failed';
    case AiStatusInProgress = 'ai-status--in-progress';
    case AiStatusQueued = 'ai-status--queued';
    case AiStatusRejected = 'ai-status--rejected';
    case AiStatus = 'ai-status';
    case Angle = 'angle';
    case AnnotationVisibility = 'annotation-visibility';
    case ArrowAnnotation = 'arrow--annotation';
    case AutoScroll = 'auto-scroll';
    case BrushFreehand = 'brush-freehand';
    case BrushPolygon = 'brush-polygon';
    case CdArchive = 'cd--archive';
    case CdCreateArchive = 'cd--create-archive';
    case CdCreateExchange = 'cd--create-exchange';
    case CircleMeasurement = 'circle-measurement';
    case CobbAngle = 'cobb-angle';
    case ContourDraw = 'contour--draw';
    case ContourEdit = 'contour--edit';
    case ContourFinding = 'contour-finding';
    case CrossReference = 'cross-reference';
    case CutInHalf = 'cut-in-half';
    case Denominate = 'denominate';
    case Dicom6000 = 'dicom--6000';
    case DicomOverlay = 'dicom--overlay';
    case Dna = 'dna';
    case DownloadStudy = 'download-study';
    case EdgeEnhancement01 = 'edge-enhancement--01';
    case EdgeEnhancement02 = 'edge-enhancement--02';
    case EdgeEnhancement03 = 'edge-enhancement--03';
    case EdgeEnhancement = 'edge-enhancement';
    case Erase3D = 'erase--3D';
    case FusionBlender = 'fusion-blender';
    case HangingProtocol = 'hanging-protocol';
    case HoleFillingCursor = 'hole-filling--cursor';
    case HoleFilling = 'hole-filling';
    case ICA2D = 'iCA-2D';
    case ImageAvailabilityLocal = 'image-availability--local';
    case ImageAvailabilityRetrieving = 'image-availability--retrieving';
    case ImageAvailabilityUnavailable = 'image-availability--unavailable';
    case InteractiveSegmentationCursor = 'interactive-segmentation-cursor';
    case LaunchStudy1 = 'launch-study--1';
    case LaunchStudy2 = 'launch-study--2';
    case LaunchStudy3 = 'launch-study--3';
    case Magnify = 'magnify';
    case Mammogram = 'mammogram';
    case Nominate = 'nominate';
    case PageScroll = 'page-scroll';
    case PetImageB = 'pet-image--B';
    case PetImageO = 'pet-image--O';
    case PointerText = 'pointer-text';
    case RegionAnalysisArea = 'region-analysis--area';
    case RegionAnalysisVolume = 'region-analysis--volume';
    case Registration = 'registration';
    case Rotate180 = 'rotate--180';
    case Rotate360 = 'rotate--360';
    case SaveAnnotation = 'save--annotation';
    case SaveImage = 'save--image';
    case SaveSeries = 'save--series';
    case ScalpelCursor = 'scalpel--cursor';
    case ScalpelLasso = 'scalpel--lasso';
    case ScalpelSelect = 'scalpel--select';
    case SmoothingCursor = 'smoothing--cursor';
    case Smoothing = 'smoothing';
    case SpineLabel = 'spine-label';
    case SplitDiscard = 'split--discard';
    case StackedMove = 'stacked-move';
    case StackedScrolling1 = 'stacked-scrolling--1';
    case StackedScrolling2 = 'stacked-scrolling--2';
    case StatusAcknowledge = 'status--acknowledge';
    case StatusChange = 'status--change';
    case StatusPartialFail = 'status--partial-fail';
    case StatusResolved = 'status--resolved';
    case StressBreathEditor = 'stress-breath-editor';
    case StudyNext = 'study--next';
    case StudyPrevious = 'study--previous';
    case StudyRead = 'study--read';
    case StudySkip = 'study--skip';
    case StudyTransfer = 'study--transfer';
    case StudyUnread = 'study--unread';
    case StudyView = 'study--view';
    case SubVolume = 'sub-volume';
    case TextAnnotationToggle = 'text-annotation-toggle';
    case Threshold = 'threshold';
    case ThumbnailPreview = 'thumbnail-preview';
    case WindowAuto = 'window--auto';
    case WindowBase = 'window--base';
    case WindowBlackSaturation = 'window--black-saturation';
    case WindowOverlay = 'window--overlay';
    case WindowPreset = 'window--preset';
